...
class HomePage:
    def __init__(self, root, switch_frame):
        ...
        map_dot_frame = tk.Frame(right_frame)
        map_dot_frame.grid(row=1, column=0, pady=20, sticky='nsew')

        # Map
        map_image_path = 'map.pgm'
        self.map_image = ImageTk.PhotoImage(Image.open(map_image_path))
        map_label = tk.Label(map_dot_frame, image=self.map_image, background='#333333')
        ...
        red_dot = tk.Canvas(map_dot_frame, width=10, height=10, background='#333333', highlightthickness=0)
